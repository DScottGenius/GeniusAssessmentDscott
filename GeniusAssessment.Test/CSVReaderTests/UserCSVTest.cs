...
namespace GeniusAssessment.Test.CSVReaderTests
{
    ...
    class UserCSVTest
    {
        ...
        [TestCase(@"C:\Users\dscott\Documents\Training\Assessment\placement 211214.csv", ExpectedResult = 2, TestName = "Test valid users added: valid file")]
        [TestCase(@"C:\Users\dscott\Documents\Training\Assessment\direct payments 11042022.csv", ExpectedResult = 0, TestName = "Test users not added: invalid file")]
        ...
        {
            readUserCSV = new ReadUserCSV(@"C:\Users\dscott\Documents\Training\Assessment\placement 211214.csv");
